...
export const BASELINE_ROUTES = [
  ...
  { path: "/management/portfolio-book", kind: "detail-or-alias" },
  { path: "/management/persona-league", kind: "detail-or-alias" },
  { path: "/management/quarterly-ranking", kind: "detail-or-alias" },
  { path: "/management/performance-attribution", kind: "detail-or-alias" },
  ...
  { path: "/management/capital", kind: "detail-or-alias" },
  { path: "/management/ranking", kind: "detail-or-alias" },
  { path: "/management/rebalance", kind: "detail-or-alias" },
