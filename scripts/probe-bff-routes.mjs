...
const BASE = process.env.PANTHEON_BFF_BASE_URL || process.env.VITE_BFF_BASE_URL || "https://api.dev.mvl-cap.tw";
...
const routes = [
  ...
  ["POST", "/bff/logout"],
  ["POST", "/bff/actions/strategy/strategy-dev/promote_paper"],
  ["GET", "/bff/strategies"],
