          ...
          <ErrorBoundary scope="App">
            ...
            <Route element={<PlatformShellRoute />}>
              <Route path="/management" element={<ManagementLayoutRoute />}>
                ...
                <Route path="capital-pools/:id" element={<CapitalPoolDetailRoute />} />
                ...
                <Route path="rebalances/:id" element={<RebalanceDetailRoute />} />
                ...
                <Route path="research/:id" element={<ResearchDetailRoute />} />
