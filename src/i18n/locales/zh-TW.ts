export default {
  ...
  v5: {
    controlRoom: { subtitle: "Pantheon 控制中樞 — 統合 KPI、迴圈、Sentinel 與介入佇列。", topLoops: "重點迴圈" },
    loops: {
      subtitle: "研究 / 執行 / 最佳化三條閉環的執行紀錄。",
      research: { title: "研究迴圈執行" },
      execution: { title: "執行迴圈" },
    ...
    kpi: { loopsRunning: "執行中迴圈", loopsBlocked: "卡住迴圈", openFindings: "未處理 Findings", pendingInterventions: "待處理介入" },
    col: { subject: "主體", kind: "類別", status: "狀態", next: "下一步", total: "總計" },
    empty: "暫無資料。",
