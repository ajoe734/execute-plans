// BFF Contract v1 — SSE bridge + realtime bus (mock + live transport owner).
// ACG-03-006 / ACG-03-014: the in-memory pub/sub bus previously lived in
// src/lib/bff/realtime.ts (an upward bff-v1 -> bff -> bff-v1 import cycle
// through liveStatus). It is owned here now; src/lib/bff/realtime.ts is a
// compatibility re-export for existing external callers.
//
...
// In `live` mode this bus is fed by ./liveSse (EventSource/fetch-stream adapter).
