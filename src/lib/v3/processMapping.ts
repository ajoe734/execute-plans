...
export const PROCESS_SURFACE_MAPPING: readonly ProcessSurfaceMapping[] = [
  ...
  { processId: "P08", processName: "Capital Pool Mandate & Binding",     primaryRoute: "/management/promotion-allocation?tab=quarterly-capital", detailRoute: "/management/promotion-allocation?tab=quarterly-capital&capital_id=:id", relatedTabs: ["Mandate","Persona Binding","Strategy Binding"] },
  { processId: "P09", processName: "Ranking Formula Lifecycle",          primaryRoute: "/management/promotion-allocation?tab=formula-policy", detailRoute: "/management/promotion-allocation?tab=formula-policy&formula_id=:id", relatedTabs: ["Performance & Ranking","Ranking Inputs"] },
  { processId: "P10", processName: "Quarterly Rebalance",                primaryRoute: "/management/promotion-allocation?tab=quarterly-capital", detailRoute: "/management/promotion-allocation?tab=quarterly-capital&rebalance_id=:id", relatedTabs: ["Quarterly Allocation","Overrides & Audit"] },
