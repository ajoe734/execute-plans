  ...
  return (
    <>
      ...
      <HighRiskConfirm
        ...
        destructive
        onConfirm={async (memo) => { await bff.mutations.runAction({ kind: "RankingFormula", id: rf.id, action: "activate", memo }); toast.success("Activation requested — pending approval"); }}
      />
    </>
  );
};
