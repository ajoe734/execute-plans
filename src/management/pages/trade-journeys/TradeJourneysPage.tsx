...
import { getTradeJourney, getTradeJourneyEvidence, getTradeJourneyTimeline, listTradeJourneys, resolveTradeJourney, type JourneyDetailEnvelope, type JourneyListEnvelope, type JourneyMeta, type JourneyRow } from "@/lib/bff-v1/tradeJourneys";
...
export function TradeJourneyDetailPage() {
  ...
  const [detail, setDetail] = useState<JourneyDetailEnvelope>(); const [timeline, setTimeline] = useState<JourneyListEnvelope>(); const [evidence, setEvidence] = useState<Record<string, unknown>>(); const [error, setError] = useState("");
