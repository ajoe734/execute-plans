...
export const SideNav = ({ groups }: { groups: NavGroup[] }) => (
  <nav className="w-60 shrink-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border sticky top-14 self-start h-[calc(100vh-3.5rem)] overflow-hidden hover:overflow-y-auto overscroll-contain scrollbar-thin py-4 px-2">
    {groups.map((g) => (
