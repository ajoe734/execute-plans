...
export const SideNav = ({ groups }: { groups: NavGroup[] }) => {
  ...
  return (
    <nav className="hidden w-60 shrink-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border py-4 px-2 lg:sticky lg:top-14 lg:block lg:self-start lg:h-[calc(100vh-3.5rem)] lg:overflow-y-auto lg:overscroll-contain lg:scrollbar-thin">
      {groups.map((g) => (
